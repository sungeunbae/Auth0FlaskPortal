...
/home/seb56/py36_devel/bin/uwsgi --http 0.0.0.0:3000 --http-websockets --plugins python,gevent --gevent 100 --mount /=server:main_app --master -b 8192 --logger file:logfile=logs/uwsgi.log,maxsize=200000 #32768
